...
{
	$option = get_option('ecocoded_themepage_seen');
	$awaiting = !$option ? ' <span class="awaiting-mod">1</span>' : '';
	$theme_info = add_theme_page(__('Theme Settings', 'ecocoded'), __('Theme Settings', 'ecocoded').$awaiting, 'manage_options', 'ecocoded-info.php', 'ecocoded_info_page', 1);
}
function ecocoded_info_page()
{
	...
	$option_name = 'ecocoded_themepage_seen';
		...
		<div class="spt-theme-settings-wrapper">
			<div class="spt-theme-settings-wrapper-main-content">
				<div class="spt-theme-settings-tabs">
					...
					<div class="spt-theme-settings-tab">
						...
						<label class="spt-theme-settings-label" for="tab-1"><?php esc_html_e("Get started with", "ecocoded"); ?> <?php echo esc_html($theme_name); ?></label>
							...
							<div class="spt-theme-settings-content-getting-started-wrapper">
								<div class="spt-theme-settings-content-item">
									...
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('nav-menus.php'))  ?>"><?php esc_html_e("Go to Menus", "ecocoded"); ?></a>
									</div>
								</div>
								...
								<div class="spt-theme-settings-content-item">
									...
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('widgets.php'))  ?>"><?php esc_html_e("Go to Widgets", "ecocoded"); ?></a>
									</div>
								</div>

								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Change Header Image", "ecocoded"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "ecocoded"); ?></a>
									</div>
								</div>

								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Customize Header Text & Background", "ecocoded"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "ecocoded"); ?></a>
									</div>
								...
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Custom Navigation Text Color", "ecocoded"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "ecocoded"); ?></a>
									</div>
								...
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Change Background Color / Image", "ecocoded"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "ecocoded"); ?></a>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize All Fonts", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize All Colors", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Import Demo Content", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Demo Import", "ecocoded"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Contact Premium Support", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Unlock Full SEO Optimization", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Only show header background image on the front page", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize Header Text & Button", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize menu item text color", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Custom header top & bottom spacing", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Unlock Elementor Compatibility", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Install Elementor", "ecocoded"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Access All Child Themes", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("View Child Themes", "ecocoded"); ?></span>
									</div>
								</a>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Add Recent Posts Widget", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Widgets", "ecocoded"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Only show upper widgets on the front page", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Custom Copyright Text", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Remove 'Tag' from tag page title", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Remove 'Author' from author page title", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Remove 'Category' from author page title", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Show Header Image Everywhere", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/ecocoded/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Hide Sidebar", "ecocoded"); ?></span> <span><?php esc_html_e("Premium", "ecocoded"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "ecocoded"); ?></span>
									</div>
			...
			<div class="spt-theme-settings-wrapper-sidebar">
				...
				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Additional Resources", "ecocoded"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<ul>
							<li>
								<a target="_blank" href="https://wordpress.org/support/forums/"><span class="dashicons dashicons-wordpress"></span><?php esc_html_e("WordPress.org Support Forum", "ecocoded"); ?></a>
							</li>
							<li>
								<a target="_blank" href="https://www.facebook.com/superbthemescom/"><span class="dashicons dashicons-facebook-alt"></span><?php esc_html_e("Find us on Facebook", "ecocoded"); ?></a>
							</li>
							<li>
								<a target="_blank" href="https://twitter.com/superbthemescom"><span class="dashicons dashicons-twitter"></span><?php esc_html_e("Find us on Twitter", "ecocoded"); ?></a>
							</li>
							<li>
								<a target="_blank" href="https://www.instagram.com/superbthemes/"><span class="dashicons dashicons-instagram"></span><?php esc_html_e("Find us on Instagram", "ecocoded"); ?></a>
							</li>
				...
				<div class="spt-theme-settings-wrapper-sidebar-item">
					...
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						...
						<a href="https://superbthemes.com/demo/ecocoded/" target="_blank" class="button button-primary"><?php esc_html_e("View Demo", "ecocoded"); ?></a>
					</div>
				</div>
				...
				<div class="spt-theme-settings-wrapper-sidebar-item">
					...
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						...
						<a href="https://superbthemes.com/ecocoded/" target="_blank" class="button button-primary"><?php esc_html_e("View Premium Version", "ecocoded"); ?></a>
					</div>
				</div>

				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Helpdesk", "ecocoded"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
				...
				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Review the Theme", "ecocoded"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
